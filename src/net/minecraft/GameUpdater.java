...
import net.rotten194.PatchingClassLoader;


 /**
 * @author Markus Persson ("Notch"), modified by Jonathon "Rotten194" Vogel (jonathon.vogel[at]gmail[dot]com)
 *
 */
public class GameUpdater
   implements Runnable
 {
     ...
     throws Exception
   {
     ...
     if (classLoader == null) {
       classLoader = new PatchingClassLoader(urls);
     }
